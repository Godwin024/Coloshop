          ...
          
    {
      ...
      <h4>Spanish</h4>
...

         {
          ...
          <h4> <HiMiniArrowRightOnRectangle style={{color:"black", marginRight: "10px", fontSize: "9px"}} onClick={()=>Nav(`signup/$`)}/> Log In</h4>
          <hr />
          <h4> <MdPersonAddAlt1 style={{color:"black", marginRight: "10px", fontSize: "9px"}} onClick={()=>Nav(`register/$`)}/>Register</h4>
        </div> : null
         }
